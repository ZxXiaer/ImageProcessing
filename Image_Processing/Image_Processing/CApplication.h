...
namespace _excel
{
	...
	public:
		...
		{
			BOOL result;
			InvokeHelper(0xcec, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
			return result;
		}
		void put_CSVKeepLeadingZerosAsText(BOOL newValue)
		{
			static BYTE parms[] = VTS_BOOL;
			InvokeHelper(0xcec, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
		}
		BOOL get_CSVKeepLargeNumbersAsText()
		{
			BOOL result;
			InvokeHelper(0xced, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
			return result;
		}
		void put_CSVKeepLargeNumbersAsText(BOOL newValue)
		{
			static BYTE parms[] = VTS_BOOL;
			InvokeHelper(0xced, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
		}
		BOOL get_CSVKeepDigitsWithEAsText()
		{
			BOOL result;
			InvokeHelper(0xcee, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
			return result;
		}
		void put_CSVKeepDigitsWithEAsText(BOOL newValue)
		{
			static BYTE parms[] = VTS_BOOL;
			InvokeHelper(0xcee, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
		}
