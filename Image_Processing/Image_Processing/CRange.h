...
namespace _excel
{
	...
	public:
		...
		{
			VARIANT result;
			InvokeHelper(0xcf8, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, NULL);
			return result;
		}
		void ShowCard()
		{
		...
		{
			VARIANT result;
			InvokeHelper(0x62c, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, NULL);
			return result;
		}
		...
		{
			VARIANT result;
			InvokeHelper(0xce4, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, NULL);
			return result;
		}
		...
		{
			VARIANT result;
			InvokeHelper(0xce5, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, NULL);
			return result;
		}
		...
		{
			VARIANT result;
			InvokeHelper(0xce6, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, NULL);
			return result;
		}
		...
		{
			VARIANT result;
			InvokeHelper(0xce7, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, NULL);
			return result;
		}
