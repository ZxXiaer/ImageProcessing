...
namespace _excel
{
	...
	public:
		...
		CString PublishToDocs(LPCTSTR Title, long DisclosureScope, VARIANT& OverwriteUrl)
		{
			...
			InvokeHelper(0xd00, DISPATCH_METHOD, VT_BSTR, (void*)&result, parms, Title, DisclosureScope, &OverwriteUrl);
			return result;
		}
		LPDISPATCH LookUpInDocs(VARIANT& Filename)
		{
			LPDISPATCH result;
			static BYTE parms[] = VTS_VARIANT;
			InvokeHelper(0xd01, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, &Filename);
			return result;
		}
